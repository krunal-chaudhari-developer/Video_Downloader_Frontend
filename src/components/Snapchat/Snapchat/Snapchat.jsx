...
const Snapchat = () => {
  ...
  const handleClick = (e) => {
    ...
    axios
      .get(
        `https://download-snapchat-video-spotlight-online.p.rapidapi.com/download?url=${action.downloadLink}`,
        {
          headers: {
            "X-RapidAPI-Key":
              "0eab5d4b20mshb5a8a678eb89507p162cdajsncd7236cf8d56",
            "X-RapidAPI-Host":
              "download-snapchat-video-spotlight-online.p.rapidapi.com",
          },
        }
      )
      .then((res) => {
        ...
        <div className="py-14">
          <div className="flex justify-center">
            <h1 className="navbar text-center text-3xl lg:text-4xl">
              Snapchat Spotlights Downloader
            </h1>
          </div>

          <div className="flex justify-center">
            <h1 className="navbar text-center lg:text-lg">
              Download Stories and Spotlights Online
            </h1>
          </div>
            ...
            <div className="flex justify-between bg-white rounded-lg my-10 mx-2 ">
              <div className="p-2">
                <input
                  ...
                  placeholder="Paste Snapchat URL"
                  onChange={(e) =>
