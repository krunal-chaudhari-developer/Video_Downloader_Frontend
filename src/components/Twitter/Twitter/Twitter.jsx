...
const Twitter = () => {
  ...
  const handleClick = (e) => {
    ...
    axios
      .get(
        `https://twitter-downloader-download-twitter-videos-gifs-and-images.p.rapidapi.com/status?url=${action.downloadLink}`,
        {
          headers: {
            "X-RapidAPI-Key":
      ...
      <div className="bg-green-100">
        <div className="py-14">
          ...
          <div className="flex justify-center">
            {action.open && (
              <a
                href={data.media.video.videoVariants[2].url}
                target="_blank"
                rel="noreferrer"
